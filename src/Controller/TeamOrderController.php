...
class TeamOrderController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager): Response
    {
       ...
       {
           $name=$team->getTeam1(); $name->setPoint(0);
           $name=$team->getTeam2(); $name->setPoint(0);
           $entityManager->flush();
       }
       foreach ($match as $team1) {
           if ($team1->getScore1() > $team1->getScore2()) {
               $name = $team1->getTeam1();
               $score=$name->getPoint() + 3;
               $name->setPoint($score);
           } elseif ($team1->getScore1() < $team1->getScore2()) {
